...
def show_post(post_id):
    ...
    return render_template("post.html", post=requested_post, form=form, current_user=current_user, commentdb=posts, image=image)
...
def login():
    ...
    if form.validate_on_submit():
        ...
        #password dengan id diatas = user.password

        # #utk password tidak di hash
